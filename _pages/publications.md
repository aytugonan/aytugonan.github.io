...
- Onan, A., Özger, F., & Turhan, N. (2026). q-Parametric Bezier-Driven Functional Kolmogorov-Arnold Networks for Biomedical Image Enhancement and Segmentation, Expert Systems with Applications.
...
- Monika, W., Dewi, D. A., Nasution, A. H., Onan, A., & Murakami, Y. (2026). Retrieval-augmented generation for curated thematic corpora: A critical survey, bibliometric evidence, and the ThemePath-RAG framework. Information.
...
- Toçoğlu, M.A., & Onan, A. (2021). Identification of sport news in Turkish news using deep learning architectures. In Progress in Intelligent Decision Science (pp. 3-13). Springer, Cham.
...
- Öztürk, O., Özer-Kaya, D., & Onan, A. (2026). İvmeölçer Tabanlı Fiziksel Aktivite Tanıma için Makine Öğrenimi ve Derin Öğrenme Modellerinin Karşılaştırmalı Analizi,  İzmir Katip Çelebi Üniversitesi Sağlık Bilimleri Fakültesi Dergisi.
- Baştürk, B., Onan, A. (2026). Topic Modeling-Based Coherence Analysis of Biomedical Text Abstracts Generated by LLM, Bilişim Teknolojileri Dergisi.
